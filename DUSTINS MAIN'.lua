...
if LPH_OBFUSCATED == nil then
    ...
    LRM_ScriptName = "BypassinCracked"
    ...
    LPH_JIT_MAX(function()
        ...
        if Game_Name == "The Bronx" then
            ...
            HideUI = LPH_NO_VIRTUALIZE(function(Title, Timing)
                ...
                TitleLabel.Text = "realest BYPASSIN"
                ...
                textLabel.Text = '\n<font color="rgb(255,0,0)">LURKOUT ON TOP</font>\n' .. Title
...
local window = Library:Window({Prefix = "MADE BY DUSTIN V2.0", Suffix ="nolimet hub"})
...
if Game_Name == "The Bronx" then
    ...
    do -- \\ Bank Actions
        local Player_Utility_Section = Column:Section({Name = " MADE BY DUSTIN", Side = "Left"})
            ...
            Callback = function(toggle)
                ...
                if usernameLabel and usernameLabel:IsA("TextLabel") then
                    if toggle then
                        ...
                        usernameLabel.Text = "https://discord.gg/GMt5MbBRHG"
                    else
...
do -- \\ Main Page
    ...
    do -- \\ Notifications Section
        ...
        local spamMessage = "FUCK BYPASSIN!!! LURKOUT ON TOP - https://discord.gg/GMt5MbBRHG"
        local spamCount = 1
        local spamDelay = 0.1
                ...
                if state then
                    task.spawn(function()
                        ...
                        for i = 1, spamCount do
                            ...
                            pcall(function()
                                firesignal(Event.OnClientEvent, spamMessage or "Fuck bypassin. LURKOUT ON TOP!!! - https://discord.gg/GMt5MbBRHG", Color3.fromRGB(42, 208, 255), spamDuration)
                            end)
                            task.wait(spamDelay)
                        end
